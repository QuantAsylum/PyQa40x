...
thd_db = wave_adc.compute_thd(1000)
thd_pct = wave_adc.compute_thd(1000, unit="pct")

thdn_db = wave_adc.compute_thdn(1000, debug=True)
thdn_pct = wave_adc.compute_thdn(1000, unit="pct")

print(f"THD: {thd_db:.2f} dB    THDN: {thdn_db:.2f} dB")
